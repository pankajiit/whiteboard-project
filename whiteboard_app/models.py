...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    user_groups = models.ManyToManyField('auth.Group', related_name='custom_user_groups', blank=True)
...
class Whiteboard(models.Model):
    ...
    owner = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='whiteboards')
